<x-teacher-layout title="{{$task->title}}">
    ...
    <div>
        <div class="dark-purple rounded-xl flex gap-2 px-3 py-4 my-4">
            <button id="editUpload" class="uppercase block text-xs px-4 py-3 rounded-lg font-bold bg-violet-800">edit judul Tugas</button>
        </div>

        <div id="modalEditUpload" class="fixed hidden justify-center items-center w-full h-screen bg-black bg-opacity-70 top-0 left-0 ">
                ...
                <div class="order-2 md:order-1 w-full md:w-[70%] lg:w-[75%] space-y-2">
                    <div id="upload" class="flex flex-col gap-3 justify-between bg-main px-4 py-6 rounded-2xl">
                        ...
                        <div class="flex flex-col mt-2 gap-3">  
                            ...
                            @endif
                            <div class="flex">
                                <button id="buttonEditEssay" data-uploadId="{{$upload->id}}" data-question="{{$upload->question}}" class="buttonEditEssay text-sky-400 font-semibold uppercase text-sm px-8 rounded-l-xl py-2 border border-r-0 border-sky-400">Edit</button>
