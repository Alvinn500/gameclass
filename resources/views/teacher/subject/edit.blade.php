        ...
        <form id="formSubject" action="/teacher/lesson/{{$lesson->id}}/subject/edit/{{$subject->id}}" method="POST" enctype=multipart/form-data>
            ...
            <div class="bg-main p-4 rounded-lg">
                <div class="flex flex-col mb-4">
                    ...
                    <input class="focus:outline-none bg-main rounded-lg text-sm py-2.5 px-3 border" type="text" name="title" id="title" placeholder="Judul Materi" value="{{$subject->title}}">
                ...
                <div class="border border-black border-opacity-30 my-4 rounded-lg">
                    ...
                    <div id="editor">{!! $subject->content !!}</div>
                </div>
