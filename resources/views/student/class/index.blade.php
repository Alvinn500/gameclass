<x-student-layout title="Kelas">
        ...
        <div class=" w-full">
            <a href="/student/class/find" class="w-full md:w-auto inline-block uppercase bg-main text-neutral-800 shadow-md rounded-md px-4 py-3.5 font-bold text-xs mb-6">Temukan Kelas</a>
