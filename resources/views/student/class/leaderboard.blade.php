<x-student-layout title="Leaderboard">
    ...
    <div class="flex mt-6">
        ...
        <div class="w-[50%] px-4 py-6 bg-main shadow-md mb-4 rounded-xl">
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="flex justify-between px-3 py-3 dark-green border-r-4 border-lime-500">
                    <h3 class="text-neutral-50 text-sm">Belum ada siswa yang mendapatkan skor</h3>
                </div>
                @endif
                @foreach ($leaderboards as $leaderboard)
                    <div class="flex justify-between px-3 py-3 shadow-md rounded-l-md dark-green border-r-4 border-lime-500">
                        ...
                        <div> 
                            <p class="font-semibold">{{$leaderboard["total_xp"]}}</p>
                        </div>
                    </div>
                @endforeach
            </div>
