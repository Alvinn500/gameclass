<x-teacher-layout title="Hasil Quiz">
    ...
    <x-student-sub-nav
        ...
        <div class="mt-6">
            <div class="dark-green flex flex-col sm:flex-row rounded-xl pb-8 sm:pb-0">
                ...
                <div class="w-full sm:w-[60%] flex flex-col justify-center items-center sm:items-start gap-4">
                    <h1 class="font-bold text-3xl">{{$task->title}}</h1>
                    <p class="text-base font-semibold">kamu mendapatkan reward {{$rewerdXP}} xp</p>
                    <div>
