<nav>
    <ul class="flex flex-col sm:flex-row text-center sm:text-left gap-2 bg-main py-2 px-3 rounded-xl">
        <li><a class="uppercase text-xs block sm:inline-block text-gray-600 py-3 px-4 font-bold {{preg_match('/class|lesson|task|quiz|essay/', request()->path()) ? "bg-whiteSubNav text-white rounded-lg uppercase" : ""}}" href="{{$classPath}}">kelas</a></li>
